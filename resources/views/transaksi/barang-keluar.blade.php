{{-- resources/views/transaksi/barang-keluar.blade.php --}}
@extends('layouts.app')
    ...
    <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        ...
        <form method="POST" action="{{ route('transaksi.barang-keluar.store') }}" class="space-y-5" id="barangKeluarForm">
            ...
            <div>
                ...
                <p id="invalidBarang" class="text-sm text-red-600 mt-1 hidden">Barang tidak valid.</p>
            </div>

            <div>
                <label for="jumlah_keluar" class="block text-sm font-medium text-gray-700 mb-1">Jumlah Keluar</label>
